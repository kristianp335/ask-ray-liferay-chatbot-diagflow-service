...
public interface ApiAiDataLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApiAiDataLocalServiceUtil} to access the api ai data local service. Add custom service methods to {@link com.liferay.kris.apiai.service.impl.ApiAiDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApiAiData fetchApiAiDataByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApiAiData getApiAiDataByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	...
	public java.lang.String addApiAiData(ServiceContext serviceContext,
