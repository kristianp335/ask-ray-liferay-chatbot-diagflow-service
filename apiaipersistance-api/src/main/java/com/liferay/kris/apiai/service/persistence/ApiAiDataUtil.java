...
public class ApiAiDataUtil {
	...
	private static ServiceTracker<ApiAiDataPersistence, ApiAiDataPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ApiAiDataPersistence.class);

		ServiceTracker<ApiAiDataPersistence, ApiAiDataPersistence>
			serviceTracker =
				new ServiceTracker<ApiAiDataPersistence, ApiAiDataPersistence>(
					bundle.getBundleContext(), ApiAiDataPersistence.class,
					null);
